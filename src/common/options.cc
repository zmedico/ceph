...
std::vector<Option> global_options = {
  ...
  .set_default("bitmap")
  .add_tag("mkfs")
  .set_description("Allocator to use for bluestore.  Choices are: bitmap (preferred) and stupid (only for testing)")
...
Option("bluestore_throttle_cost_per_io_hdd", Option::TYPE_UINT, Option::LEVEL_ADVANCED)
  ...
  .set_default(false)
  .set_description("Whether or run fsck on mount for kstore."),
