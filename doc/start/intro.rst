...
- **Managers**: A :term:`Ceph Manager` daemon is responsible for keeping
  track of runtime metrics and the current state of the Ceph cluster, including
...
- **Ceph OSDs**: A :term:`Ceph OSD` (object storage daemon) stores
...
- **MDSs**: A :term:`Ceph Metadata Server` (MDS) stores metadata on
